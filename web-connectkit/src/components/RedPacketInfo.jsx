...
export default function RedPacketInfo({ info, onGrabRedPacket, isLoading }) {
  if (!info || !info[4]) { // info[4] is initialized
    return (
      <div className="bg-white bg-opacity-20 backdrop-opacity-10 rounded-2xl p-6 card-hover text-center">
  ...
  return (
    <div className="bg-white bg-opacity-20 backdrop-opacity-10 rounded-2xl p-6 card-hover">
